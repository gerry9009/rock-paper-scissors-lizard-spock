    ...
    return (
      <div className="game-container">
        <Link to="/play" className="img-link">
          ...
          >
            <img className="game-img game-img-rock" src={rock} alt="rock" />
        ...
        <Link to="/play" className="img-link">
          <div
            ...
            onClick={this.handleClick}
          >
            <img className="game-img game-img-paper" src={paper} alt="paper" />
        ...
        <Link to="/play" className="img-link">
          <div
            ...
            onClick={this.handleClick}
          >
            <img className="game-img game-img-spock" src={spock} alt="spock" />
            <h3 className="img-title">Spock</h3>
          </div>
        </Link>
      </div>
    );
